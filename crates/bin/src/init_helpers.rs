...
#   EXTENDDB__STORAGE__{backend_env}__CONNECTION_STRING="..."
...
# throttling_enabled = false     # Frontend throttling for non-native backends; TiDB uses native Resource Control
