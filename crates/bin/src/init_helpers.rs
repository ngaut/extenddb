...
pub(crate) fn generate_config(
    config_path: &str,
    bootstrapper: &extenddb_storage_tidb::TidbBootstrapper,
    bind_addr: &str,
    docs_dir: Option<&str>,
) -> anyhow::Result<()> {
    ...
    let storage_section = bootstrapper.generate_storage_config_section();
...
#   EXTENDDB__STORAGE__TIDB__CONNECTION_STRING="..."
...
# max_batch_get_response_bytes = 16777216
# max_batch_write_request_bytes = 16777216
# max_transaction_request_bytes = 4194304
...
# max_expression_attribute_names_bytes = 2097152
# max_expression_attribute_values_bytes = 2097152
