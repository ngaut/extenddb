...
//! `AdminStore` implementation for `TidbCatalogStore`.

use extenddb_storage::management_store::{AdminEntry, OpError, OpResult};
use futures::future::BoxFuture;

use super::catalog_store::TidbCatalogStore;
use super::tidb_util::is_unique_violation;

impl extenddb_storage::management_store::AdminStore for TidbCatalogStore {
