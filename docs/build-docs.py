...
DOCUMENTS = [
    ...
    (12, "getting-started", "Getting Started", "getting-started",
     "docs/getting-started.md"),
    (13, "troubleshooting", "Troubleshooting", "usage",
     "docs/troubleshooting.md"),
    (14, "differences-from-dynamodb", "Differences from DynamoDB", "reference",
     "docs/differences-from-dynamodb.md"),
    (15, "dynamodb-limits", "DynamoDB Limits", "reference",
     "docs/dynamodb-limits.md"),
    (16, "event-ticketing-demo", "Event Ticketing Platform Demo", "getting-started",
